<h1>Create recommendation for <cfoutput>#user.firstname# #user.lastName#</cfoutput></h1>
...
<div class="clearfix">
   ...
   <cfoutput>
     <div>
      #startFormTag(action="createRecommendation", class="contactForm")#
        ...
        <div class="field">
          #submitTag(value="Recommend User", class="submit")#
        </div>
      #endFormTag()#
     </div>
    </cfoutput>
